...
export function TurnLine({
  ...
  const tone = holder === null ? 'var(--ink-faint)' : toneForSeat(holder.seatIndex)

  return (
    <p
      className={`turn${yours ? ' turn--yours' : ''}`}
